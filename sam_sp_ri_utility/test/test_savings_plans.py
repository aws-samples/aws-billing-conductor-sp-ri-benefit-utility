...
default_account_associations_response = {
	'ResponseMetadata': {'RequestId': '8a94e821-2206-439b-9267-3856ff64203e', 'HTTPStatusCode': 200,
		...
		{'AccountId': '111111111111', 'AccountName': 'Audit', 'AccountEmail': 'ct-audit@example.com'},
		{'AccountId': '222222222222', 'AccountName': 'Log Archive',
		 'AccountEmail': 'ct-logarchive@example.com'},
		{'AccountId': '789456123012', 'AccountName': 'payer', 'AccountEmail': 'payer@example.com'},
...
def test_create_savings_plans_custom_line_items_for_standard_input(mock_ec2_usage, mock_client):
	...
	mock_ec2_usage.return_value = {'555555555555': Decimal('7656'), '444444444444': Decimal('4872')}
	actual = create_savings_plans_custom_line_items(date(2024, 2, 1), date(2024, 3, 1), True, False, False)
...
def test_create_savings_plans_custom_line_items_for_commitment_purchased_in_billing_group(mock_ec2_usage, mock_client):
	...
	mock_client().get_savings_plans_utilization_details.return_value = {'SavingsPlansUtilizationDetails': [
		...
		'ResponseMetadata': {
			...
			'RetryAttempts': 0}}
	mock_client().list_account_associations.return_value = default_account_associations_response
	mock_ec2_usage.return_value = {'555555555555': Decimal('50'), '444444444444': Decimal('50')}
	actual = create_savings_plans_custom_line_items(date(2024, 2, 1), date(2024, 3, 1), True, False, False)
	assert is_equal_list_of_dict(actual, expected)
...
def test_create_savings_plans_custom_line_items_for_fargate_usage(mock_fargate_usage, mock_ec2_usage, mock_client):
	...
	mock_client().get_savings_plans_utilization_details.return_value = {'SavingsPlansUtilizationDetails': [
		...
		'ResponseMetadata': {
			...
			'RetryAttempts': 0}}
	mock_client().list_account_associations.return_value = default_account_associations_response
	mock_ec2_usage.return_value = {'555555555555': Decimal('100'), '444444444444': Decimal('50')}
	mock_fargate_usage.return_value = {'555555555555': Decimal('100'), '444444444444': Decimal('50')}
	actual = create_savings_plans_custom_line_items(date(2024, 2, 1), date(2024, 3, 1), True, True, False)
	assert is_equal_list_of_dict(actual, expected)
...
def test_create_savings_plans_custom_line_items_for_lambda_usage(mock_lambda_usage, mock_ec2_usage, mock_client):
	...
	mock_client().get_savings_plans_utilization_details.return_value = {'SavingsPlansUtilizationDetails': [
		...
		'ResponseMetadata': {
			...
			'RetryAttempts': 0}}
	mock_client().list_account_associations.return_value = default_account_associations_response
	mock_ec2_usage.return_value = {'555555555555': Decimal('199'), '444444444444': Decimal('99')}
	mock_lambda_usage.return_value = {'555555555555': Decimal('1'), '444444444444': Decimal('1')}
	actual = create_savings_plans_custom_line_items(date(2024, 2, 1), date(2024, 3, 1), True, False, True)
	assert is_equal_list_of_dict(actual, expected)
...
def test_create_savings_plans_custom_line_items_for_fargate_and_lambda_usage(mock_lambda_usage, mock_fargate_usage,
	...
	mock_client().get_savings_plans_utilization_details.return_value = {'SavingsPlansUtilizationDetails': [
		...
		'ResponseMetadata': {
			...
			'RetryAttempts': 0}}
	mock_client().list_account_associations.return_value = default_account_associations_response
	mock_ec2_usage.return_value = {'555555555555': Decimal('198'), '444444444444': Decimal('98')}
	mock_fargate_usage.return_value = {'555555555555': Decimal('1'), '444444444444': Decimal('1')}
	mock_lambda_usage.return_value = {'555555555555': Decimal('1'), '444444444444': Decimal('1')}
	actual = create_savings_plans_custom_line_items(date(2024, 2, 1), date(2024, 3, 1), True, True, True)
	assert is_equal_list_of_dict(actual, expected)
